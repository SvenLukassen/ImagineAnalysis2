...
def data_parameters(train_dir, validate_dir, test_dir):
    ...
    try:
        ...
        print(e)
        print("Unknown error has been raised")
...
def run_model(model, train_generator, validation_generator, test_generator):
    ...
    :return: epochs - number of times the model will be fitted
             history - all the model parameters.
    """
    try:
        # Compiles the model
        ...
        print("to much memory has been used")
    except NameError as e:
        print(f"Variable name {e} has not been found")
    except NotADirectoryError:
        print("Directory not found")
    except Exception as e:
        print(e)
